...
Fundación Markoptic A.C. iniciará un proceso de estudio de la solicitud y se contactara con usted personalmente al momento de haber analizado y ser verificada la información proporcionada, si en caso contrario de no haber sido aceptada su solicitud será incluido a la lista de espera. Fundación Markoptic A.C. no se compromete a fabricar el dispositivo, pero si a dar el seguimiento necesario de investigación.
                                        </textarea>
                                    </div>
                                </div>
                                <div class="col-xs-12">
