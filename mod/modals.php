        <!-- foo 1 -->
<div class="modal fade" id="foo1" tabindex="-1" role="dialog" aria-labelledby="Dispositivos Donados a la Sociedad">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-reflex">
    ...
    <!-- foo2 -->
<div class="modal fade" id="foo2" tabindex="-1" role="dialog" aria-labelledby="Mejorar la Calidad de Vida">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-cyan">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="foo2">Mejorar la Calidad de Vida</h4>
      </div>
        <div class="modal-body">
    ...
    <!-- foo3 -->
<div class="modal fade" id="foo3" tabindex="-1" role="dialog" aria-labelledby="Primera Fundacion Tecnologica en Mexico">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
...
<div class="modal fade" id="foo5" tabindex="-1" role="dialog" aria-labelledby="Laboratorio de Clase Mundial">
  <div class="modal-dialog" role="document">
    ...
    <!-- foo6-->
<div class="modal fade" id="foo6" tabindex="-1" role="dialog" aria-labelledby="Jóvenes en Actividades de Desarrollo Tecnológico">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-naranja">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="foo6">Jóvenes en Actividades de Desarrollo Tecnológico</h4>
      </div>
        <div class="modal-body">
    ...
    <!-- foo7-->
<div class="modal fade" id="foo7" tabindex="-1" role="dialog" aria-labelledby="Oportunidad de Trabajo">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-mark">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="foo7">Oportunidad de Trabajo</h4>
      </div>
        <div class="modal-body">
    ...
    <!-- foo8-->
<div class="modal fade" id="foo8" tabindex="-1" role="dialog" aria-labelledby="Tecnología para Donar a más Familias">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-aqua">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="foo8">Tecnología para Donar a más Familias</h4>
      </div>
        <div class="modal-body">
    ...
    <!-- foo9-->
<div class="modal fade" id="foo9" tabindex="-1" role="dialog" aria-labelledby="Se dona a quien más lo necesita">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-rosado">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="foo9">Se dona a quien más lo necesita</h4>
      </div>
        <div class="modal-body">
    ...
    <!-- foo10-->
<div class="modal fade" id="foo10" tabindex="-1" role="dialog" aria-labelledby="Vinculación con las Universidades Prestigiadas">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-verde">
        ...
        <div class="modal-body">
            <img class="img-responsive center-block" src="img/university.png">
      ...
      <div class="modal-header modal-mark modal-magenta">
        ...
        <div class="modal-body">
            <ul class="rslides">
                ...
                <li><img src="img/recognize_itc.png"></li>
...
<div class="modal fade" id="noticia2" tabindex="-1" role="dialog" aria-labelledby="Jovenes Emprendedores - Verano FESE 2015">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-magenta">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="noticia2">Jóvenes Emprendedores - Verano 2015</h4>
      </div>
...
<div class="modal fade" id="noticia3" tabindex="-1" role="dialog" aria-labelledby="Certificación Solidworks">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-magenta">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="noticia3">Certificación en SolidWorks</h4>
      </div>
      <div class="modal-body">
...
<div class="modal fade" id="noticia4" tabindex="-1" role="dialog" aria-labelledby="Recibo Deducible de Inpuestos">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-magenta">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="noticia3">Recibo Deducible De Impuestos</h4>
      </div>
      <div class="modal-body">
...
<div class="modal fade" id="noticia10" tabindex="-1" role="dialog" aria-labelledby="Demostración del Colchón Inflable Anti-escaras">
  <div class="modal-dialog" role="document">
    ...
    <!-- pop up inicio -->
<div class="modal fade" id="itt" tabindex="-1" role="dialog" aria-labelledby="Certificaciones">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header modal-mark modal-magenta">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
