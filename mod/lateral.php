...
<div class="panel panel-default panel-mark ">
    ...
    <div style="padding:10px;" class="panel-body panel-body-mark">
        ...
        <span class="img-thumbnail bg-mark text-center">
            <h4 class="oswald"><strong>Conoce los proyectos de nuestro Centro de Investigación</strong></h4>
            <img style="width:100%" src="img/thumb/thumb-arm.jpg" />
            <img style="width:100%" src="img/thumb/thumb-car.jpg" />
            <img style="width:100%" src="img/thumb/thumb-mattress.jpg" />
        </span>
        </a>
    </div>
</div>
