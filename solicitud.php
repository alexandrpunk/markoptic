            ...
            <div class="col-md-9">
                ...
                <?php require 'mod/menu.php';?>
                  ...
                  <div class="panel panel-default panel-mark animated fadeIn">
                    <div class="panel-heading panel-heading-mark" id="rosado">Solicitud de Prótesis/Colchon</div>
                    <div class="panel-body panel-body-mark">    
                        ...
                        <div class="" id="form-solicitud-seccion1">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label for="peticion" class="col-sm-3 control-label">Peticion</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group hidden" id="form-solicitud-seccion1-1">
                                    <label for="opcion_protesis" class="col-sm-3 control-label">Opciones de Protesis</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="pais" id="pais">
                                            <option value="">Seleccioné Su Pais</option>
                                            <?php
                                            foreach ($paises as $p) {
                                            ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Calle y Numero">
                                    </div>
                                </div>
                        ...
                        <div class="hidden" id="form-solicitud-seccion4">
                            ...
                            <div class="">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="direccion">Calle y Numero</label>
                                        <input type="text" class="form-control" id="t_direccion" name="t_direccion" placeholder="Calle y Numero">
                                    </div>
                                </div>
                        ...
                        <div class="hidden" id="form-solicitud-seccion5">
                            ...
                            <div class="">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="porque">Cuentanos Porque La Necesitas</label>
                                ...
                                <div class="col-sm-12">
                                    <center><h4>Envianos Fotografias o Video</h4></center>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">Tamaño maximo de archivo 20 MB</p>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
...
Fundación Markoptic A.C. iniciará un proceso de estudio de la solicitud y se contactara con usted personalmente al momento de haber analizado y ser verificada la información proporcionada, si en caso contrario de no haber sido aceptada su solicitud será incluido a la lista de espera.
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="checkbox" id="checkbox-tyc" value="aceptyc">  Accepto los Terminos y Condiciones.
                                        </label>
                                    </div>
                                </div>
